...
<CardGrid>
  <Card title="New to terminal multiplexers?">
    You don't need to learn shortcuts to start. Herdr is mouse-first: click panes, drag borders, right-click to paste, split and switch from `shift`+right-click menus.
