...
pub use self::{
    ...
    git::{
        ...
        git_space_identity, git_space_metadata, git_status_cache_key, GitDiffLine, GitDiffLineKind,
        GitDiffText, GitDirtyCounts, GitSpaceMetadata, GitStatusCacheEntry, GitStatusRefreshDemand,
    },
    tab::{NewPane, Tab},
};
pub(crate) use self::{
