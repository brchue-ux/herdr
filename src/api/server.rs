...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::WorkspaceReportSignal(_) => "workspace.report_signal",
        ...
        Method::LayoutArrange(_) => "layout.arrange",
        ...
        Method::PaneReportEditDiff(_) => "pane.report_edit_diff",
        Method::PaneClearAgentAuthority(_) => "pane.clear_agent_authority",
        Method::PaneReleaseAgent(_) => "pane.release_agent",
        Method::PaneDeclareAgent(_) => "pane.declare_agent",
        Method::PaneClose(_) => "pane.close",
        Method::SurfaceGraphicsSet(_) => "surface.graphics.set",
        Method::SurfaceGraphicsClear(_) => "surface.graphics.clear",
        Method::SurfaceGraphicsInfo(_) => "surface.graphics.info",
