...
pub enum Method {
    ...
    #[serde(rename = "session.status.set")]
    SessionStatusSet(SessionStatusSetParams),
    #[serde(rename = "session.status.clear")]
    SessionStatusClear(EmptyParams),
    ...
    #[serde(rename = "layout.arrange")]
    LayoutArrange(LayoutArrangeParams),
    ...
    #[serde(rename = "pane.report_edit_diff")]
    PaneReportEditDiff(PaneReportEditDiffParams),
    ...
    #[serde(rename = "pane.declare_agent")]
