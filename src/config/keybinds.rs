...
pub struct Keybinds {
    ...
    pub cycle_layout: ActionKeybinds,
    pub close_pane: ActionKeybinds,
    pub zoom: ActionKeybinds,
    pub resize_mode: ActionKeybinds,
    pub toggle_sidebar: ActionKeybinds,
    pub toggle_diff_pane: ActionKeybinds,
...
impl Config {
    pub(super) fn validated_keybinds(&self) -> (Option<String>, KeyCombo, Vec<String>, Keybinds) {
        ...
        for source in [BindingSource::User, BindingSource::Default] {
            ...
            apply_action!(keybinds.cycle_layout, cycle_layout, source);
            ...
            apply_action!(keybinds.toggle_diff_pane, toggle_diff_pane, source);
