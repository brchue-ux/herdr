...
pub(super) fn keybind_help_groups(app: &AppState) -> Vec<HelpGroup> {
    ...
    let workspace_tab = vec![
        ...
        help_entry(
            keybind_label(&kb.new_scratch_workspace),
    ...
    let panes = vec![
        ...
        help_entry(keybind_label(&kb.cycle_layout), "cycle layout"),
        ...
        help_entry(keybind_label(&kb.toggle_diff_pane), "toggle diff pane"),
