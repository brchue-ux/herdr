use crate::api::schema::{
    EmptyParams, Method, PaneDeclareAgentParams, PaneFocusDirectionParams, PaneMoveParams,
...
pub(super) fn pane_declare_agent(params: PaneDeclareAgentParams) -> std::io::Result<i32> {
    print_method_response("cli:pane:declare_agent", Method::PaneDeclareAgent(params))
}
