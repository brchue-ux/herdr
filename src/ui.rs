...
pub(crate) use self::{
    ...
    sidebar::category::AgentCategory,
    sidebar::{
        agent_category_tab_at, agent_entry_gap, agent_entry_height_in_body, agent_panel_body_rect,
        agent_panel_control, agent_panel_entries, agent_panel_scroll_for_target,
