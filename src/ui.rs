...
pub(crate) use self::{
    ...
    sidebar::{
        agent_entry_gap, agent_entry_height_in_body, agent_panel_body_rect, agent_panel_control,
        agent_panel_entries, agent_panel_scroll_for_target, agent_panel_scroll_metrics,
        agent_panel_scrollbar_rect, all_agent_panel_entries, collapsed_sidebar_sections,
