...
pub(crate) use self::{
    ...
    sidebar::{
        agent_panel_entries, all_agent_panel_entries, card_row_folds_into_a_mate,
        collapsed_sidebar_sections, collapsed_sidebar_toggle_rect, compute_workspace_card_areas,
        expanded_sidebar_toggle_rect, normalized_workspace_scroll, rows_with_departing,
        sidebar_agent_entries, sidebar_agent_live_entries, sidebar_agent_row_members,
        sidebar_space_row_members, sidebar_tree_breadcrumb_rect, sidebar_tree_handle,
...
pub(crate) use self::{
    ...
    tabs::{compute_tab_bar_view, tab_bar_content_area, TabLabelDecor},
